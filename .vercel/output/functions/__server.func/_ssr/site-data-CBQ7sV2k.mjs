import { C as HeartPulse, L as Apple, P as Brain, R as Activity, c as Sparkles, f as Salad, i as Waves, k as ClipboardCheck } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/site-data-CBQ7sV2k.js
var BRAND = {
...
var SERVICES = [
	{
		...
		description: "Achieve sustainable weight loss with personalized nutrition plans and expert lifestyle coaching.",
		icon: Activity,
		image: "/service7.jpeg"
	},
	{
		...
		description: "Build healthy daily habits and improve your overall lifestyle with practical wellness support.",
		icon: Sparkles,
	...
	},
	{
		...
		description: "Learn how to make smart, sustainable food choices for long-term health.",
		icon: Apple,
	...
	},
	{
		...
		description: "Understand your current lifestyle and get clear guidance for improvement.",
		icon: ClipboardCheck,
	...
	},
	{
		...
		description: "Polycystic Ovary Syndrome (PCOS)—often referred to as PCOD—has been officially renamed Polyendocrine Metabolic Ovarian Syndrome (PMOS).",
		icon: HeartPulse,
	...
	},
	{
		...
		description: "Lifestyle-focused nutrition guidance to support better sugar control and metabolic health.",
		icon: Waves,
		image: "/service8.jpeg"
	},
	{
		...
		description: "Practical nutrition and lifestyle coaching to support metabolism, energy, weight management, and overall thyroid wellness.",
		icon: Brain,
	...
	},
	{
		...
		description: "Develop strong daily habits with coaching focused on nutrition, fitness, sleep, consistency, and overall wellness.",
		icon: Salad,
...
var STORIES = [
	{
		...
		quote: "The plan felt realistic from day one. There were no crash diets or unrealistic restrictions—just simple, sustainable habits that fit my lifestyle. Over time, I felt healthier, more energetic, and more confident in my daily life.",
	...
	},
	{
		...
		quote: "The coaching went beyond food. Sleep, stress, movement — everything came together. My PCOS symptoms are finally manageable.",
		image: "/testimonial (4).jpeg"
	}
];
//#endregion
export { STORIES as a, SERVICES as i, FAQS as n, NAV as r, BRAND as t };
